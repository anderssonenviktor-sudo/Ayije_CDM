...
local RESOURCE_BAR_PER_KEY = {
    ...
    HolyPower       = {
        color = { r = 0.95, g = 0.9, b = 0.6, a = 1 },
        divinePurposeColorEnabled = false,
        divinePurposeColor = { r = 1, g = 0.5, b = 0.8, a = 1 },
        anchorTo = "Mana",
        offsetY = 1,
    },
    ...
    Essence         = {
        ...
        essenceBurstColorEnabled = false,
        essenceBurstColor = { r = 1, g = 0.85, b = 0.36, a = 1 },
        anchorTo = "Mana",
        offsetY = 1,
    },
...
CDM.defaults = {
    ...
    castBarShowArcaneMissilesTicks = false,
    castBarArcaneMissiles4Piece = false,
