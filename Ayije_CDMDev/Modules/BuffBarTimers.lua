...
local bbDescriptor = GCU and GCU.CreateDescriptor({
    ...
    namePrefix = "Ayije_CDMDev_BuffBarGroup",
...
local function GetUngroupedHost()
    ...
    if not ungroupedFallbackHost then
        ungroupedFallbackHost = _G["Ayije_CDMDev_BBTHost"]
            or CreateFrame("Frame", "Ayije_CDMDev_BBTHost", UIParent)
...
local function IsPreviewActive()
    ...
    local configFrame = _G.Ayije_CDMDevConfigFrame
