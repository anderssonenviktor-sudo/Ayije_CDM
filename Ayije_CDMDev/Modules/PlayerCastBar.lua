...
local CASTBAR_BG_TEXTURE = "Interface\\AddOns\\Ayije_CDMDev\\Media\\Textures\\blizzcastback"
...
local function UpdateEmpowerPips(frame, scaledPercentages)
    ...
    local pipWidth = Snap(Pixel.GetSize() * 2)
    local pipHeight = Snap(barHeight * 0.9)
...
function CDM:CreatePlayerCastBar()
    ...
    local container = CreateFrame("Frame", "Ayije_CDMDev_CastBarContainer", UIParent)
