...
if LSM then
    LSM:Register("border", "Ayije_Thin", "Interface\\AddOns\\Ayije_CDMDev\\Media\\Borders\\Ayije_Thin.tga")
    LSM:Register("border", "Ayije_Empty", "Interface\\AddOns\\Ayije_CDMDev\\Media\\Borders\\Ayije_Empty.tga")
...
local function GetBorderDef()
    ...
    if not borderFile and borderKey ~= "None" then
        borderFile = "Interface\\AddOns\\Ayije_CDMDev\\Media\\Borders\\Ayije_Thin.tga"
    end
