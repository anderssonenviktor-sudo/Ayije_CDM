...
local function CreateConfigFrame()
    ...
    ConfigFrame = CreateFrame("Frame", "Ayije_CDMDevConfigFrame", UIParent, "SettingsFrameTemplate")
    ConfigFrame:SetSize(920, 720)
    ConfigFrame:SetPoint("CENTER", UIParent, "CENTER", 0, 0)
    ConfigFrame:SetFrameStrata("HIGH")
    ConfigFrame:Hide()
    tinsert(UISpecialFrames, "Ayije_CDMDevConfigFrame")
